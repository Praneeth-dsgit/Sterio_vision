...
echo "  4. python3 -m server   (or: ./scripts/run.sh)"
echo "  5. On Quest 3 Browser open the HTTPS URL (port 8443) and accept the cert"
echo
echo "Start on boot (Quest hotspot — no manual server start):"
echo "  chmod +x scripts/install-service.sh && ./scripts/install-service.sh"
